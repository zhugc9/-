...
# 模型池配置（包含备用模型支持）
MODEL_POOLS = CONFIG.get('media_text', {}).get('model_pools', {
    "primary_models": {
        'UNIT_EXTRACTION': api_config['models'].get('media_text_extraction'),
        'UNIT_ANALYSIS': api_config['models'].get('media_text_analysis')
    }
})
