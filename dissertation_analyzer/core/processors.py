            ...
            if 'processing_status' in df_existing.columns:
                ...
                if identifiers:
                    ...
                    if candidate_cols:
                        ...
                        df_existing = df_existing[~(drop_mask & match_mask)]
...
class VKProcessor(BaseProcessor):
    ...
    def _load_vk_pending_units(self, output_path, mapping):
        ...
        for _, row in df_pending.iterrows():
            pending_unit = {
                ...
                comment_text_col: safe_str_convert(row.get(comment_text_col)),
    ...
    async def process(self, df, output_path, source='vk'):
        ...
        analysis_columns = ANALYSIS_COLUMNS + ['Unit_Hash']
            ...
            for item in result:
                ...
                if 'processing_status' not in item:
                    ...
                    if relevance == '不相关':
                        ...
                        item['processing_status'] = ProcessingStatus.PENDING_ANALYSIS
