...
def create_unified_record(record_type, original_id, source="未知来源", text_snippet="", failure_reason=""):
    ...
    elif record_type in {ProcessingStatus.API_FAILED, ProcessingStatus.STAGE_1_FAILED, ProcessingStatus.STAGE_2_FAILED}:
        return {
            **base_record,
            "speaker": "API_CALL_FAILED",
            "Unit_Text": f"[{record_type}] {failure_reason}: {text_snippet[:200]}...",
            ...
            "Attribution_Level": record_type,
            "Temporal_Focus": record_type,
            "Primary_Actor_Type": record_type,
            "Geographic_Scope": record_type,
            "Relationship_Model_Definition": record_type,
            "Discourse_Type": record_type
        }
